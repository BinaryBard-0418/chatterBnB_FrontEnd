            ...
            <div className="d-flex align-items-center justify-content-center w-100">
                ...
                <div className="col-md-8 col-lg-6 col-xxl-3">
                    ...
                    <div className="card-body">
                        <a href="signup" className="text-nowrap logo-img text-center d-block py-3 w-100">
                        ...
                        <div className="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" onClick={createNewMember}>Sign Up</div>
                        <div className="d-flex align-items-center justify-content-center">
                            <p className="fs-4 mb-0 fw-bold">Already have an Account?</p>
                            <a className="text-primary fw-bold ms-2" href="signin">Sign In</a>
                        </div>
                        </form>
                    </div>
                    </div>
